...
class ReportsBloc extends Bloc<ReportsEvent, ReportsState> {
  ...
  ReportsBloc(this._repository) : super(ReportsState(transactionsReportsStatus: GetReportsInitial())) {
    on<GetTransactionsReportsEvent>((event, emit) async{
      ...
      try{
        emit(state.copyWith(newTransactionsReportsStatus: GetReportsSuccess(chartData: chartData)));
      }catch(e){
        emit(state.copyWith(newTransactionsReportsStatus: GetReportsError('خطا در دریافت گزارشات')));
      }
